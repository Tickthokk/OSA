var manage = {
	...
	setup_datatable:function() {
		manage.datatable = $('#game_list').dataTable({
			'bProcessing': true,
			'bServerSide': true,
			'sAjaxSource': '/admin/games/datatable',
			// Bootstrap Capable
			...
			"aoColumnDefs": [
		      { "bSortable": false, "aTargets": [ 2 ] } // Disable sorting on actions column
		    ],
		    // Column Widths
		    "bAutoWidth": false,
			"aoColumns": [
		...
		// Live Events
		$("#game_list tbody").on("mouseover", 'tr', function() {
			var tr = $(this);
